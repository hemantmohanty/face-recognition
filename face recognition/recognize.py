...
classifier = cv2.CascadeClassifier('C:/Users/mohan/OneDrive/Desktop/face recognition/face recognition/haarcascade_frontalface_default (1).xml')

model = load_model("C:/Users/mohan/OneDrive/Desktop/face recognition/face recognition/final_model.h5")

URL = 'http://192.0.0.4:8080/shot.jpg'

def get_pred_label(pred):
    labels = ['Aditya', 'Amit', 'Hemant']
    return labels[pred]
